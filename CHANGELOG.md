...
## [0.10.33-beta] - 2025-12-05

### Naprawiono
- **Testy - DELETE endpoint:** Naprawiono test DELETE dla `/api/clients/[id]` - teraz używa użytkownika z rolą ADMIN zamiast USER, ponieważ endpoint wymaga roli ADMIN do usuwania klientów
